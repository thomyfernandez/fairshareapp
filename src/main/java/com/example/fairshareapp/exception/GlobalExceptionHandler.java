...
/**
 * Manejador global de excepciones: unica clase que traduce cualquier error de la API
 * a un contrato de respuesta comun (ErrorResponseDTO), con el codigo HTTP y la categoria
 * que correspondan. Ningun otro @RestControllerAdvice debe agregarse al proyecto: toda
 * nueva categoria de error se resuelve agregando una excepcion reutilizable aqui.
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja excepciones provocadas por inconsistencias o violaciones de reglas de negocio.
     */
    ...
    /**
     * Maneja errores de validacion de un DTO anotado con @Valid en el cuerpo de la solicitud,
     * devolviendo todos los campos invalidos (nunca el valor rechazado, ya que puede ser sensible).
     */
    ...
    /**
     * Maneja errores de validacion sobre parametros sueltos (query params o path variables)
    ...
    /**
     * Maneja un cuerpo de solicitud JSON mal formado, con tipos incorrectos o valores de enum
    ...
    /**
     * Maneja la ausencia de un parametro obligatorio (query param o form param) en la solicitud.
     */
    ...
    /**
     * Maneja un parametro (query param o path variable) cuyo valor no puede convertirse
    ...
    /**
     * Maneja excepciones cuando un usuario autenticado no tiene permisos suficientes.
     */
    ...
    /**
     * Maneja el rechazo de acceso generado por Spring Security (por ejemplo, via @PreAuthorize)
     * cuando ocurre dentro del despacho de un controlador, con el mismo contrato de error.
     */
    ...
    /**
     * Maneja cualquier excepcion de la categoria de conflicto (email duplicado, membresia
    ...
    /**
     * Maneja violaciones de integridad de datos a nivel de base. Solo se traduce a 409 cuando
     * la causa raiz indica claramente una violacion de unicidad o clave duplicada; cualquier
     * otra violacion de integridad (por ejemplo una clave foranea) se reporta como 400,
    ...
    /**
     * Maneja una solicitud realizada con un metodo HTTP no soportado por el endpoint.
     */
    ...
    /**
     * Maneja cualquier excepcion generica no prevista, registrando el detalle del lado del
